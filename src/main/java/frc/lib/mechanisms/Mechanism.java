...
public abstract class Mechanism<T extends MotorIO> {
    ...
    public Mechanism<T> withRadius(Distance radius) {
        ...
        this.loggedLinearPositionError =
                new LoggedDouble(this.name + "/LinearPositionError", 0.005);
        this.loggedLinearVelocity = new LoggedDouble(this.name + "/LinearVelocity", 0.005);
        this.loggedLinearVelocityError =
                new LoggedDouble(this.name + "/LinearVelocityError", 0.005);
        return this;
    }
