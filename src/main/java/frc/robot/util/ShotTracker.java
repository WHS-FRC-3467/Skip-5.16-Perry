...
public class ShotTracker {
    ...
    private final Debouncer hopperEmptyDebouncer = new Debouncer(0.7, DebounceType.kRising);
    ...
    private final LoggedDouble totalFuelLogger;

    public ShotTracker(ShooterSuperstructure shooter) {
        this.shooter = shooter;
        this.totalFuelLogger = new LoggedDouble("ShotTracker/TotalFuelCount");
