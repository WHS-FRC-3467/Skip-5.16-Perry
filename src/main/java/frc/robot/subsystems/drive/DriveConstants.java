...
public class DriveConstants {
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.60107421875);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.98779296875);
