...
public record ChoreoTraj(
        ...
        Pose2d endPoseBlue) {
    public static final ChoreoTraj B1 =
            new ChoreoTraj(
                    "B1",
                    OptionalInt.empty(),
                    4.83467,
    ...
    public static final ChoreoTraj B2 =
            new ChoreoTraj(
                    "B2",
                    OptionalInt.empty(),
                    7.01275,
    ...
    public static final ChoreoTraj B3 =
            new ChoreoTraj(
                    "B3",
                    OptionalInt.empty(),
                    6.10957,
    ...
    public static final ChoreoTraj C16782 =
            new ChoreoTraj(
                    ...
                    new Pose2d(3.1, 5.2, Rotation2d.fromRadians(-0.68187)),
                    new Pose2d(3.1, 5.2, Rotation2d.fromRadians(-0.68185)));
    public static final ChoreoTraj C16783 =
            new ChoreoTraj(
                    "C16783",
                    OptionalInt.empty(),
                    7.01104,
    ...
    public static final ChoreoTraj BumpPath =
            new ChoreoTraj(
                    ...
                    new Pose2d(3.1, 5.2, Rotation2d.fromRadians(-0.68187)));
    public static final ChoreoTraj FullNeutral2 =
            new ChoreoTraj(
                    "FullNeutral2",
                    OptionalInt.empty(),
                    2.20459,
    ...
    public static final ChoreoTraj FullNeutral3 =
            new ChoreoTraj(
                    "FullNeutral3",
                    OptionalInt.empty(),
                    4.50995,
    ...
    public static final ChoreoTraj Neutral2ML_1_Safe2 =
            new ChoreoTraj(
                    ...
                    new Pose2d(6.7, 7.39928, Rotation2d.fromRadians(1.5708)),
                    new Pose2d(3.06667, 5.47686, Rotation2d.fromRadians(-0.80285)));
    public static final ChoreoTraj FullNeutral1 =
            new ChoreoTraj(
                    "FullNeutral1",
                    OptionalInt.empty(),
                    4.78737,
