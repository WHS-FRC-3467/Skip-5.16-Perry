...
public final class Quaternion extends Struct {
    ...
    public static int createQuaternion(
            FlatBufferBuilder builder, double w, double x, double y, double z) {
        builder.prep(8, 32);
        builder.putDouble(z);
        builder.putDouble(y);
        builder.putDouble(x);
    ...
    public static final class Vector extends BaseVector {
        ...
        public Quaternion get(int j) {
            return get(new Quaternion(), j);
        }

        public Quaternion get(Quaternion obj, int j) {
